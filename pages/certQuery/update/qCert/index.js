  ...
  onLoad: function (options) {
    ...
    that.setData({
      submitData: {
        ...
        certificateOrganization: oldData.certificateOrganization,                    //发证单位
    ...
    // 同步证书类型teacherType
    for (var j in that.data.teacherType.names) {
      if (that.data.teacherType.names[j] == oldData.extInfo.teacherLevel) {
        that.setData({ ["teacherType.current"]: j })
        break
      }
    }
